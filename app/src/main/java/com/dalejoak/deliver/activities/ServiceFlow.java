package com.dalejoak.deliver.activities;
...
import com.dalejoak.deliver.Application;
import com.dalejoak.deliver.R;
import com.dalejoak.deliver.adapter.ProductAdapter1;
import com.dalejoak.deliver.api.APIError;
import com.dalejoak.deliver.api.ErrorUtils;
import com.dalejoak.deliver.helper.ConnectionHelper;
import com.dalejoak.deliver.helper.CustomDialog;
import com.dalejoak.deliver.helper.GlobalData;
import com.dalejoak.deliver.helper.OnlySeekableSeekBar;
import com.dalejoak.deliver.helper.SharedHelper;
import com.dalejoak.deliver.model.Address;
import com.dalejoak.deliver.model.Invoice;
import com.dalejoak.deliver.model.Item;
import com.dalejoak.deliver.model.Message;
import com.dalejoak.deliver.model.Order;
import com.dalejoak.deliver.model.Ordertiming;
import com.dalejoak.deliver.model.Shop;
import com.dalejoak.deliver.model.User;
                    ...
                    amount_paid.addTextChangedListener(new TextWatcher() {
                        ...
                        public void afterTextChanged(Editable s) {
                            if (!s.toString().equals("")) {
                                double amountPaid = Integer.parseInt(s.toString());
